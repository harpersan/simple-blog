  ...
  methods: {
    onFileChange: function onFileChange(e) {
      ...
      reader.onload = function (e) {
        _this.form.images = e.target.result; // this.url = null
      };
    },
    onSubmit: function onSubmit() {
      ...
      if (!this.form.images) {
        ...
        axios.post('/create-post', this.$data.form).then(function (response) {
          _this2.button_text = 'Success';
          _this2.button_color = 'bg-blue-500';
          window.location.href = '/' + _this2.user;
        })["catch"](function (error) {
          if (error.response.status == 422) {
            _this2.errors.save(error.response.data.errors);
          }
        });
      }
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    onFileChange: function onFileChange(e) {
      ...
      reader.onload = function (e) {
        _this.form.images = e.target.result;
        _this.image = null;
      };
    },
    onSubmit: function onSubmit() {
      ...
      // alert('asdasdasd');
      axios.post('/update-post', this.$data.form).then(function (response) {
        _this2.button_text = 'Success';
        _this2.button_color = 'bg-blue-500';
        window.location.href = '/' + _this2.user;
      })["catch"](function (error) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    this.form.email = this.user.email; // this.form.profile_images = this.user.profile_images;
  ...
  methods: {
    onFileChange: function onFileChange(e) {
      ...
      reader.onload = function (e) {
        _this.form.profile_images = e.target.result;
        _this.image = null;
        _this.default_image = false;
      };
    },
    onSubmit: function onSubmit() {
      var _this2 = this;
      ...
      // alert('asdasdasd');
      axios.post('/update-profile', this.$data.form).then(function (response) {
        _this2.button_text = 'Success';
        _this2.button_color = 'bg-blue-500';
        window.location.href = '/' + _this2.form.name;
      })["catch"](function (error) {
        if (error.response.status == 422) {
          _this2.errors.save(error.response.data.errors);
        }
...
var render = function() {
  ...
  return _c("div", [
    _c(
      ...
      {
        staticClass:
          "w-full max-w-2xl mx-auto border shadow rounded p-5 mt-10 bg-white",
        on: {
      ...
      [
          ...
          _c("div", { staticClass: "w-full px-3" }, [
            _c(
              ...
              [
                ...
                _c("p", {
                  staticClass:
                    "text-xs text-red-500 mt-2 normal-case font-semibold",
        ...
        _vm.form.images
          ? _c("div", { staticClass: "flex flex-wrap -mx-3 mb-6" }, [
              _c("div", { staticClass: "w-full px-3" }, [
                _c("img", { attrs: { src: _vm.form.images, alt: "" } })
              ])
            ])
          : _vm._e(),
        _vm._v(" "),
          ...
          [
            _c("div", { staticClass: "w-1/4" }, [
              _c(
                ...
                {
                  staticClass:
                    "bg-blue-500 px-2 py-1 text-white font-semibold rounded text-center cursor-pointer"
                },
      ...
      [
        ...
        _vm.image
          ? _c("div", { staticClass: "flex flex-wrap -mx-3 mb-6" }, [
              _c("div", { staticClass: "w-full px-3" }, [
                _c("img", {
                  attrs: { src: "/images/blogpost/" + _vm.image, alt: "" }
                })
              ])
            ])
          : _vm._e(),
  ...
  return _c("div", [
    _c("div", { staticClass: "w-full flex flex-row flex-wrap" }, [
      _c(
        ...
        {
          staticClass:
            "w-full bg-indigo-100 h-screen flex flex-row flex-wrap justify-center "
        },
        [
          _vm._m(0),
          _vm._v(" "),
          _c(
            ...
            {
              staticClass:
                "w-0 md:w-1/4 lg:w-1/5 h-0 md:h-screen overflow-y-hidden bg-white shadow-lg"
            },
            [
              _c("div", { staticClass: "p-5 bg-white sticky top-0" }, [
                _vm.default_image
                  ? _c("img", {
                      staticClass:
                        "border border-indigo-100 shadow-lg round rounded-full",
                      attrs: {
                        src:
                ...
                _vm.image
                  ? _c("img", {
                      staticClass:
                        "border border-indigo-100 shadow-lg round rounded-full w-56 h-56",
                      attrs: { src: "/images/profile/" + _vm.image }
                    })
                  : _vm._e(),
                _vm._v(" "),
                _vm.form.profile_images
                  ? _c("img", {
                      staticClass:
                        "border border-indigo-100 shadow-lg round rounded-full w-56 h-56",
                      attrs: { src: _vm.form.profile_images }
                    })
                  : _vm._e(),
                _vm._v(" "),
                _c("div", {
                  staticClass:
                    "pt-2 border-t mt-5 w-full text-center text-xl text-gray-600"
                }),
                _vm._v(" "),
                _vm._m(1)
              ]),
          ...
          _c(
            ...
            {
              staticClass:
                "w-full md:w-3/4 lg:w-4/5 p-5 md:px-12 lg:24 h-full overflow-x-scroll antialiased"
            },
            [
              _c(
                "form",
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "bg-white shadow-lg border-t-4 border-indigo-500 absolute bottom-0 w-full md:w-0 md:hidden flex flex-row flex-wrap"
      },
      [
        _c("div", { staticClass: "w-full text-right" }, [
          _c("button", { staticClass: "p-2 fa fa-bars text-4xl text-gray-600" })
        ])
      ]
    )
  },
      ...
      [
        _c("div", { staticClass: "w-full flex justify-center" }, [
          _c(
            ...
            {
              staticClass:
                "w-1/2 bg-blue-500 px-2 py-2 text-white font-semibold rounded text-center cursor-pointer"
            },
            [_vm._v("\n                            Upload Images")]
          )
        ])
  ...
  function() {
    ...
    return _c(
      ...
      {
        staticClass:
          "w-full h-screen antialiased flex flex-col hover:cursor-pointer"
      },
      [
        _c(
          "a",
          {
            staticClass:
              "hover:bg-gray-200 bg-white border-t-2 p-3 w-full text-left text-gray-600 font-semibold",
            attrs: { href: "/create-post" }
          },
          [
            _c("i", {
              staticClass:
                "fas fa-plus text-gray-600 text-xl pr-1 pt-1 float-right"
            }),
            _vm._v("Add Blog Post")
          ]
        ),
        _vm._v(" "),
        _c(
          ...
          [
            _c("i", {
              staticClass:
                "fa fa-cog text-gray-600 text-xl pr-1 pt-1 float-right"
            }),
            _vm._v("Edit\n                        Profile")
          ]
        ),
        ...
        _c(
          ...
          [
            _c("i", {
              staticClass:
                "fa fa-arrow-left text-gray-600 text-xl pr-1 pt-1 float-right"
            }),
            _vm._v("Log\n                        out")
          ]
        )
...
/* harmony import */ var _components_CreatePost_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/CreatePost.vue */ "./resources/js/components/CreatePost.vue");
/* harmony import */ var _components_EditPost_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/EditPost.vue */ "./resources/js/components/EditPost.vue");
...
var app = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  el: '#app',
  components: {
    CreatePost: _components_CreatePost_vue__WEBPACK_IMPORTED_MODULE_2__["default"],
    EditPost: _components_EditPost_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
...
__webpack_require__(/*! C:\Users\Tomachine\Desktop\simple-blog\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Tomachine\Desktop\simple-blog\resources\sass\app.scss */"./resources/sass/app.scss");
